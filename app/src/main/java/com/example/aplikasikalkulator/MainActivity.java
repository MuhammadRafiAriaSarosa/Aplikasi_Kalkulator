...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hasil = (TextView) findViewById(R.id.bersihkan);
    ...
    tambah.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if ((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0));
                ...
                Toast toast = Toast.makeText(context: MainActivity.this, text: "Mohon masukkan Angka pertama & Kedua", Toast.LENGTH_LONG);
                toast.show();
            }
    });
